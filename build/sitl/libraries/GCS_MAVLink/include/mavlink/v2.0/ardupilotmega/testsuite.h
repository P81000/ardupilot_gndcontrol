...
static void mavlink_test_msg_test_mav(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MSG_TEST_MAV >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_msg_test_mav_t packet_in = {
        17.0,"EFGHIJKLM"
    };
    mavlink_msg_test_mav_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.ex1 = packet_in.ex1;
        
        mav_array_memcpy(packet1.ex2, packet_in.ex2, sizeof(char)*10);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MSG_TEST_MAV_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MSG_TEST_MAV_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_msg_test_mav_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_msg_test_mav_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_msg_test_mav_pack(system_id, component_id, &msg , packet1.ex1 , packet1.ex2 );
    mavlink_msg_msg_test_mav_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_msg_test_mav_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.ex1 , packet1.ex2 );
    mavlink_msg_msg_test_mav_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_msg_test_mav_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_msg_test_mav_send(MAVLINK_COMM_1 , packet1.ex1 , packet1.ex2 );
    mavlink_msg_msg_test_mav_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("MSG_TEST_MAV") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_MSG_TEST_MAV) != NULL);
#endif
}

static void mavlink_test_msg_received_test(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MSG_RECEIVED_TEST >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_msg_received_test_t packet_in = {
        17.0,"EFGHIJKLM"
    };
    mavlink_msg_received_test_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.ex1 = packet_in.ex1;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MSG_RECEIVED_TEST_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MSG_RECEIVED_TEST_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_msg_received_test_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_msg_received_test_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_msg_received_test_pack(system_id, component_id, &msg , packet1.ex1 , packet1.ex2 );
    mavlink_msg_msg_received_test_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_msg_received_test_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.ex1 , packet1.ex2 );
    mavlink_msg_msg_received_test_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_msg_received_test_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_msg_received_test_send(MAVLINK_COMM_1 , packet1.ex1 , packet1.ex2 );
    mavlink_msg_msg_received_test_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("MSG_RECEIVED_TEST") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_MSG_RECEIVED_TEST) != NULL);
#endif
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_msg_test_mav(system_id, component_id, last_msg);
    mavlink_test_msg_received_test(system_id, component_id, last_msg);
}
